...
| M9-T04 | **In progress** — the PostgreSQL store, migration, and PostgreSQL 17.6 CI conformance pass; protected private-RDS migration, live isolation, and restore validation remain | Implement PostgreSQL projection, outbox, retention, and tombstone adapters | Existing M8 atomicity, pagination, deletion, and restore gates pass against RDS |
