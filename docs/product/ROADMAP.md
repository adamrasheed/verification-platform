...
| M9-T04 | **In progress** — the PostgreSQL store and CI conformance pass; a bounded private Fargate migration runner is ready, while protected private-RDS execution, live isolation/restore Evidence, and cleanup proof remain | Implement PostgreSQL projection, outbox, retention, and tombstone adapters | Existing M8 atomicity, pagination, deletion, and restore gates pass against RDS |
