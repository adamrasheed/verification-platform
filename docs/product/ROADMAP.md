...
| M9-T04 | **In progress** — the private RDS foundation is healthy and adapter implementation is next | Implement PostgreSQL projection, outbox, retention, and tombstone adapters | Existing M8 atomicity, pagination, deletion, and restore gates pass against RDS |
