...
| M9-T08 | **In progress** — closed readiness thresholds and a protected private development drill now cover load, logical backup/restore, tombstone replay, connection recovery, security, supply-chain, and abuse bounds; live run and production topology/observation Evidence remain | Run production-readiness drills and publish release Evidence | Load/SLO, backup/restore, tombstone replay, recovery, security, supply-chain, and cost-abuse Evidence pass before release status changes |
